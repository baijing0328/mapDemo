...
export const updateManagerService = (data) => request.post('/dormManager/update', data)
export const deleteManagerService = (data) => request.delete(`/dormManager/delete/${data}`)
